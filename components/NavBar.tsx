     ...
     p-3 px-10 border-b-[1px] shadow-sm'>
        <div className='flex gap-10 items-center'>
            ...
            <div className='hidden md:flex gap-6'>
                ...
                <h2 className='hover:bg-gray-100 p-2
                rounded-md cursor-pointer transition-all' onClick={()=>router.push('/Why')}>Why Us</h2>
                <h2 className='hover:bg-gray-100 p-2
                rounded-md cursor-pointer transition-all' onClick={()=>router.push('/Contact')}>Contact Us</h2>
            </div>
        </div>
